...
% Chapter 5
<<ch05Content, child="ch_inference_means/content.Rnw">>=
@
<<ch05Exercises, child="ch_inference_means/exercises.Rnw">>=
@

% Chapter 6
<<ch06Content, child="ch_inference_props/content.Rnw">>=
@
<<ch06Exercises, child="ch_inference_props/exercises.Rnw">>=
@

% Chapter 7
<<ch07Content, child="ch_regr_simple/content.Rnw">>=
@
<<ch07, child="ch_regr_simple/exercises.Rnw">>=
@
...
<<solutions, child="solutions/content.Rnw">>=
@
