...
\begin{center}
\includegraphics[width=0.93\textwidth]{ch_inference_means/figures/eoce/t_distribution/t_distribution.pdf}
\end{center}
\end{minipage}
...
\begin{center}
\includegraphics[width=0.6\textwidth]{ch_inference_means/figures/eoce/prius_fuel_efficiency/prius_fuel_efficiency_hist.pdf}
\end{center}
\begin{parts}
...
\begin{center}
\includegraphics[width=0.44\textwidth]{ch_inference_means/figures/eoce/hs_beyond_1/hs_beyond_read_write_box.pdf}
\includegraphics[width=0.54\textwidth]{ch_inference_means/figures/eoce/hs_beyond_1/hs_beyond_diff_hist.pdf}
\end{center}
\begin{parts}
...
\begin{center}
\includegraphics[width=\textwidth]{ch_inference_means/figures/eoce/gifted_children/gifted_children_IQ_hist.pdf} \\[2mm]
{\small
...
\begin{center}
\includegraphics[width=0.95\textwidth]{ch_inference_means/figures/eoce/cleveland_sacramento/cleveland_sacramento_hist.pdf}
\end{center}
\end{minipage}
...
\begin{center}
\includegraphics[width=0.95\textwidth]{ch_inference_means/figures/eoce/oscar_winners/oscars_winners_hist.pdf}
\end{center}
\end{minipage}
...
\begin{center}
\includegraphics[width=0.9\textwidth]{ch_inference_means/figures/eoce/friday_13th_traffic/friday_13th_traffic_qq.pdf} \\
$\:$ \\
{\small
...
\begin{center}
\includegraphics[width=0.85\textwidth]{ch_inference_means/figures/eoce/diamonds_1/diamonds_box.pdf}
\end{center}
\end{minipage}
}{}
...
\begin{center}
\includegraphics[width=0.74\textwidth]{ch_inference_means/figures/eoce/friday_13th_accident/friday_13th_accident_qq.pdf} \\
$\:$ \\
\begin{minipage}[c]{0.36\textwidth}
\includegraphics[width=\textwidth]{ch_inference_means/figures/eoce/friday_13th_accident/friday_13th_accident_diff_qq.pdf}
\end{minipage}
\begin{minipage}[c]{0.36\textwidth}
\ \ \begin{tabular}{l c c c}
\hline
...
\begin{center}
\includegraphics[width= \textwidth]{ch_inference_means/figures/eoce/chick_wts_linseed_horsebean/chick_wts_box.pdf}
\end{center}
\end{minipage}
...
\begin{minipage}[c]{0.6\textwidth}
\begin{center}
\includegraphics[width=0.7\textwidth]{ch_inference_means/figures/eoce/fuel_eff_city/fuel_eff_city_box.pdf}
\end{center}
\end{minipage}
}{}
...
\begin{minipage}[c]{0.6\textwidth}
\begin{center}
\includegraphics[width=0.7\textwidth]{ch_inference_means/figures/eoce/fuel_eff_hway/fuel_eff_hway_box.pdf}
\end{center}
\end{minipage}
}{}
...
\begin{center}
\includegraphics[width=\textwidth]{ch_inference_means/figures/eoce/prison_isolation_T/prison_isolation_qq.pdf} \\
$\:$ \\
...
\begin{center}
\includegraphics[width= \textwidth]{ch_inference_means/figures/eoce/chick_wts_anova/chick_wts_box.pdf}
\end{center}
\end{minipage}
\begin{minipage}[c]{0.35\textwidth}
{\footnotesize\begin{tabular}{l c c c}
...
output.
\begin{center}
\includegraphics[width=0.85\textwidth]{ch_inference_means/figures/eoce/gpa_major/gpa_major.pdf}
\end{center}
\begin{center}
\begin{tabular}{lrrrrr}
  \hline
...
\includegraphics[width=\textwidth]{ch_inference_means/figures/eoce/work_hours_education/work_hours_education.pdf}
\end{center}
\begin{parts}
...
\begin{center}
\includegraphics[width=\textwidth]{ch_inference_means/figures/eoce/child_care_hours/child_care_hours.pdf}
\end{center}
\begin{center}
\begin{tabular}{lrrrrr}
  \hline
