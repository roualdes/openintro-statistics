...
\begin{center}
\includegraphics[width = 0.75\textwidth]{chapters/intro_to_data/figures/eoce/migraine_and_acupuncture_intro/earacupuncture.pdf}
\end{center}
\end{minipage}
...
\begin{center}
\includegraphics[width = \textwidth]{chapters/intro_to_data/figures/eoce/fisher_irises/irisversicolor.jpg}
\end{center}
\end{minipage}
\begin{minipage}[c]{0.01\textwidth}
\
...
\begin{center}
\includegraphics[width = 0.78\textwidth]{chapters/intro_to_data/figures/eoce/gpa_study_hours/gpa_study_hours_scatterplot.pdf}
\end{center}
\end{minipage}
}{}
...
\begin{minipage}[c]{0.55\textwidth}
\begin{center}
\includegraphics[width = 0.78\textwidth]{chapters/intro_to_data/figures/eoce/county_income_education/county_income_education_scatterplot.pdf}
\end{center}
\end{minipage}
}{}
...
\hfill\includegraphics[width = 0.87\textwidth]{chapters/intro_to_data/figures/eoce/internet_life_expactancy/internet_life_expactancy.pdf}
\end{minipage}
}{}
...
\begin{minipage}[c]{0.55\textwidth}
\begin{center}
\includegraphics[width = 0.86\textwidth]{chapters/intro_to_data/figures/eoce/mammal_life_spans/mammal_life_spans_scatterplot.pdf}
\end{center}
\end{minipage}
}{}
...
\hfill\includegraphics[width = 0.95\textwidth]{chapters/intro_to_data/figures/eoce/association_plots/association_plots.pdf}
\end{minipage}
}{}
...
\hfill\includegraphics[width = 0.85\textwidth]{chapters/intro_to_data/figures/eoce/infant_mortality_rel_freq/infant_mortality_rel_freq_hist.pdf}
\end{minipage}
}{}
...
\begin{center}
\includegraphics[width=\textwidth]{chapters/intro_to_data/figures/eoce/hist_box_match/hist_box_match.pdf}
\end{center}
}{}
...
\begin{center}
\includegraphics[width = \textwidth]{chapters/intro_to_data/figures/eoce/air_quality_durham/air_quality_durham_rel_freq_hist.pdf}
\end{center}
\end{minipage}
}{}
...
\begin{center}
\includegraphics[width = 0.6\textwidth]{chapters/intro_to_data/figures/eoce/estimate_mean_median_simple/estimate_mean_median_simple.pdf}
\end{center}}
...
\begin{center}
\includegraphics[width = 0.6\textwidth]{chapters/intro_to_data/figures/eoce/hist_vs_box/hist_vs_box.pdf}
\end{center}
}{}
...
\begin{center}
\includegraphics[width=0.6\textwidth]{chapters/intro_to_data/figures/eoce/marathon_winners/marathon_winners_hist_box.pdf}
\end{center}
\begin{parts}
...
\begin{center}
\includegraphics[width=0.6\textwidth]{chapters/intro_to_data/figures/eoce/marathon_winners/marathon_winners_gender_box.pdf}
\end{center}
...
\end{parts}
\begin{center}
\includegraphics[width=0.75\textwidth]{chapters/intro_to_data/figures/eoce/marathon_winners/marathon_winners_time_series.pdf} \\
\end{center}
}{}
...
\includegraphics[width=\textwidth]{chapters/intro_to_data/figures/eoce/income_coffee_shop/income_coffee_shop.pdf}
\end{minipage}
...
\begin{center}
\includegraphics[width=0.48\textwidth]{chapters/intro_to_data/figures/eoce/county_commute_times/county_commute_times_hist.pdf}
\includegraphics[width=0.48\textwidth]{chapters/intro_to_data/figures/eoce/county_commute_times/county_commute_times_map.pdf}
\end{center}
\begin{parts}
...
\begin{center}
\includegraphics[width=0.48\textwidth]{chapters/intro_to_data/figures/eoce/county_hispanic_pop/county_hispanic_pop_hist.pdf}
\includegraphics[width=0.48\textwidth]{chapters/intro_to_data/figures/eoce/county_hispanic_pop/county_hispanic_pop_log_hist.pdf}
\includegraphics[width=0.48\textwidth]{chapters/intro_to_data/figures/eoce/county_hispanic_pop/county_hispanic_pop_map.pdf}
\end{center}
\begin{parts}
...
infection.
\begin{center}
\includegraphics[width = 0.45\textwidth]{chapters/intro_to_data/figures/eoce/antibiotic_use_children/antibiotic_use_children_bar}
\includegraphics[width = 0.45\textwidth]{chapters/intro_to_data/figures/eoce/antibiotic_use_children/antibiotic_use_children_pie}
\end{center}
\begin{parts}
...
\begin{center}
\includegraphics[width = 0.8\textwidth]{chapters/intro_to_data/figures/eoce/dream_act_mosaic/dream_act_mosaic.pdf}
\end{center}
}{}
...
\begin{center}
\includegraphics[width = 0.67\textwidth]{chapters/intro_to_data/figures/eoce/raise_taxes_mosaic/raise_taxes_mosaic.pdf}
\end{center}
}{}
...
\end{minipage}
\begin{minipage}[c]{0.5\textwidth}
\includegraphics[width = \textwidth]{chapters/intro_to_data/figures/eoce/randomization_avandia/randomization_avandia.pdf} \\
\end{minipage}
}{}
...
\begin{center}
\includegraphics[width= 0.46\textwidth]{chapters/intro_to_data/figures/eoce/randomization_heart_transplants/randomization_heart_transplants_mosaic.pdf}
\includegraphics[width= 0.46\textwidth]{chapters/intro_to_data/figures/eoce/randomization_heart_transplants/randomization_heart_transplants_box.pdf}
\end{center}
\begin{parts}
...
\end{parts}
\begin{center}
\includegraphics[width= 0.65\textwidth]{chapters/intro_to_data/figures/eoce/randomization_heart_transplants/randomization_heart_transplants_rando.pdf}
\end{center}
}{}
