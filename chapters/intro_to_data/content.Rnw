...
\begin{figure}
\centering
\includegraphics[width=0.57\textwidth]{chapters/intro_to_data/figures/variables/variables}
...
\begin{figure}
\centering
\includegraphics[width=0.8\textwidth]{chapters/intro_to_data/figures/county_fed_spendVsPoverty/county_fed_spendVsPoverty}
...
\begin{figure}
   \centering
   \includegraphics[width=0.8\textwidth]{chapters/intro_to_data/figures/multiunitsVsOwnership/multiunitsVsOwnership}
...
\begin{figure}
\centering
\hspace{8mm}\includegraphics[width=55mm]{chapters/intro_to_data/figures/mnWinter/mnWinter}\hspace{4mm}
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.47\textwidth]{chapters/intro_to_data/figures/popToSample/popToSampleGraduates}
...
\begin{figure}
\centering
\includegraphics[width=0.47\textwidth]{chapters/intro_to_data/figures/popToSample/popToSubSampleGraduates}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.5\textwidth]{chapters/intro_to_data/figures/popToSample/surveySample}
...
\hspace{10mm}\includegraphics[height=0.34in]{chapters/intro_to_data/figures/expResp/expResp}}
\end{tipBox}
...
\begin{center}
\includegraphics[height=1.0in]{chapters/intro_to_data/figures/variables/sunCausesCancer}
\end{center}
% Some studies:
...
\begin{figure}
\centering
\includegraphics[width=\textwidth]{chapters/intro_to_data/figures/samplingMethodsFigure/simple_stratified}
...
\begin{figure}
\centering
\includegraphics[width=\textwidth]{chapters/intro_to_data/figures/samplingMethodsFigure/cluster_multistage}
...
\begin{figure}
\centering
\includegraphics[width=0.78\textwidth]{chapters/intro_to_data/figures/figureShowingBlocking/figureShowingBlocking}
...
\begin{figure}[h]
   \centering
   \includegraphics[width=0.8\textwidth]{chapters/intro_to_data/figures/email50LinesCharacters/email50LinesCharacters}
...
\begin{figure}[h]
   \centering
   \includegraphics[width=0.8\textwidth]{chapters/intro_to_data/figures/carsPriceVsWeight/carsPriceVsWeight}
...
\begin{figure}[h]
   \centering
   \includegraphics[width=\textwidth]{chapters/intro_to_data/figures/emailCharactersDotPlot/emailCharactersDotPlot}
...
\begin{figure}[h]
   \centering
   \includegraphics[width=0.72\textwidth]{chapters/intro_to_data/figures/emailCharactersDotPlot/emailCharactersDotPlotStacked}
...
\begin{figure}[bth]
   \centering
   \includegraphics[width=0.82\textwidth]{chapters/intro_to_data/figures/email50NumCharHist/email50NumCharHist}
...
\begin{figure}[h]
   \centering
   \includegraphics[width=\textwidth]{chapters/intro_to_data/figures/singleBiMultiModalPlots/singleBiMultiModalPlots}
...
\begin{figure}
\centering
\includegraphics[width=\mycaptionwidth]{chapters/intro_to_data/figures/sdAsRuleForEmailNumChar/sdAsRuleForEmailNumChar}
...
\begin{figure}
\centering
\includegraphics[width=0.64\textwidth]{chapters/intro_to_data/figures/severalDiffDistWithSdOf1/severalDiffDistWithSdOf1}
...
\begin{figure}[h]
   \centering
   \includegraphics[width=0.86\mycaptionwidth]{chapters/intro_to_data/figures/boxPlotLayoutNumVar/boxPlotLayoutNumVar}
...
\begin{figure}[ht]
\centering
\includegraphics[width=\textwidth]{chapters/intro_to_data/figures/email50NumCharDotPlotRobustEx/email50NumCharDotPlotRobustEx}
...
\centering
\subfigure[]{
\includegraphics[width=0.46\textwidth]{chapters/intro_to_data/figures/histMLBSalaries/histMLBSalariesReg}
\label{histMLBSalariesReg}
}
\subfigure[]{
\includegraphics[width=0.46\textwidth]{chapters/intro_to_data/figures/histMLBSalaries/histMLBSalariesLog}
...
\centering
\subfigure[]{
\includegraphics[width=0.47\textwidth]{chapters/intro_to_data/figures/email50LinesCharactersMod/email50LinesCharactersMod}
\label{email50LinesCharactersMod}
}
\subfigure[]{
\includegraphics[width=0.47\textwidth]{chapters/intro_to_data/figures/email50LinesCharactersMod/email50LinesCharactersModLog}
...
\begin{figure}
\centering
\subfigure[]{\includegraphics[width=\textwidth]{chapters/intro_to_data/figures/countyIntensityMaps/countyFedSpendMap}\label{countyFedSpendMap}}
\subfigure[]{\includegraphics[width=\textwidth]{chapters/intro_to_data/figures/countyIntensityMaps/countyPovertyMap}\label{countyPovertyMap}}
...
\begin{figure}
\centering
\subfigure[]{\includegraphics[width=\textwidth]{chapters/intro_to_data/figures/countyIntensityMaps/countyHomeownershipMap}\label{countyHomeownershipMap}}
\subfigure[]{\includegraphics[width=\textwidth]{chapters/intro_to_data/figures/countyIntensityMaps/countyMedIncomeMap}\label{countyMedIncomeMap}}
...
\begin{figure}[bht]
   \centering
   \includegraphics[width=0.9\textwidth]{chapters/intro_to_data/figures/emailNumberBarPlot/emailNumberBarPlot}
...
\centering
\subfigure[]{
\includegraphics[width=0.46\textwidth]{chapters/intro_to_data/figures/emailSpamNumberSegBar/emailSpamNumberSegBar}
\label{emailSpamNumberSegBar}
}
\subfigure[]{
\includegraphics[width=0.46\textwidth]{chapters/intro_to_data/figures/emailSpamNumberSegBar/emailSpamNumberSegBarSta}
...
\centering
\subfigure[]{
\includegraphics[width=0.3934\textwidth]{chapters/intro_to_data/figures/emailSpamNumberMosaicPlot/emailNumberMosaic}
\label{emailNumberMosaic}
}
\subfigure[]{
\includegraphics[width=0.46\textwidth]{chapters/intro_to_data/figures/emailSpamNumberMosaicPlot/emailSpamNumberMosaic}
...
\begin{figure}
   \centering
   \includegraphics[width=0.44\textwidth]{chapters/intro_to_data/figures/emailSpamNumberMosaicPlot/emailSpamNumberMosaicRev}
...
\begin{figure}[h]
   \centering
   \includegraphics[width=\textwidth]{chapters/intro_to_data/figures/emailNumberPieChart/emailNumberPieChart}
...
\begin{figure}
   \centering
   \includegraphics[width=\textwidth]{chapters/intro_to_data/figures/countyIncomeSplitByPopGain/countyIncomeSplitByPopGain}
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.85\textwidth]{chapters/intro_to_data/figures/discRandDotPlot/discRandDotPlot}
