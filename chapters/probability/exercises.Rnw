...
\begin{center}
\includegraphics[width = \textwidth]{chapters/probability/figures/eoce/roulette_wheel/roulette_wheel.jpg} \\
...
\begin{center}
\includegraphics[width=\textwidth]{chapters/probability/figures/eoce/cat_weights/cat_weights.pdf}
\end{center}
\end{minipage}
}{}
