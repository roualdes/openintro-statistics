...
\begin{figure}[bt]
\centering
\includegraphics[width=0.85\textwidth]{chapters/probability/figures/dieProp/dieProp}
...
\begin{figure}[hhh]
\centering
\includegraphics[width=0.55\textwidth]{chapters/probability/figures/disjointSets/disjointSets}
...
\begin{figure}
\centering
\includegraphics[width=0.65\textwidth]{chapters/probability/figures/cardsDiamondFaceVenn/cardsDiamondFaceVenn}
...
\hfill\includegraphics[height=13mm]{chapters/probability/figures/emailSpamNumberVenn/emailSpamNumberVenn} \vspace{-13mm}
\end{minipage}
}
\end{exercise}
...
\begin{figure}
\centering
\includegraphics[width=0.68\textwidth]{chapters/probability/figures/usHouseholdIncomeDistBar/usHouseholdIncomeDistBar}
...
\begin{figure}
\centering
\includegraphics[width=0.73\textwidth]{chapters/probability/figures/diceSumDist/diceSumDist}
...
\begin{figure}[hht]
\centering
\includegraphics[width=0.55\textwidth]{chapters/probability/figures/complementOfD/complementOfD}
...
\begin{figure}[hht]
\centering
\includegraphics[width=0.6\textwidth]{chapters/probability/figures/indepForRollingTwo1s/indepForRollingTwo1s}
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.7\textwidth]{chapters/probability/figures/familyCollegeVenn/familyCollegeVenn}
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.93\textwidth]{chapters/probability/figures/smallpoxTreeDiagram/smallpoxTreeDiagram}
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.9\textwidth]{chapters/probability/figures/testTree/testTree}
...
\includegraphics[width=\textwidth]{chapters/probability/figures/treeDiagramAndPass/treeDiagramAndPass} \vspace{-25mm}
\end{minipage}}
\end{exercise}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.93\textwidth]{chapters/probability/figures/BreastCancerTreeDiagram/BreastCancerTreeDiagram}
...
\end{minipage}
\begin{minipage}[c]{0.5\linewidth}
\includegraphics[width=\textwidth]{chapters/probability/figures/treeDiagramGarage/treeDiagramGarage}\vspace{-30mm}
\end{minipage}}
\end{exercise}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.65\textwidth]{chapters/probability/figures/bookCostDist/bookCostDist}
...
\begin{figure}
\centering
\includegraphics[width=0.72\textwidth]{chapters/probability/figures/bookWts/bookWts}
...
\begin{figure}
\centering
\includegraphics[width=0.68\textwidth]{chapters/probability/figures/contBalance/contBalance}
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.65\textwidth]{chapters/probability/figures/changeInLeonardsStockPortfolioFor36Months/changeInLeonardsStockPortfolioFor36Months}
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.9\textwidth]{chapters/probability/figures/fdicHistograms/fdicHistograms}
...
\begin{figure}
\centering
\includegraphics[width=0.9\textwidth]{chapters/probability/figures/usHeightsHist180185/usHeightsHist180185}
...
\begin{figure}[tbh]
\centering
\includegraphics[width=0.9\textwidth]{chapters/probability/figures/fdicHeightContDist/fdicHeightContDist}
...
\begin{figure}
\centering
\includegraphics[width=0.8\textwidth]{chapters/probability/figures/fdicHeightContDistFilled/fdicHeightContDistFilled}
