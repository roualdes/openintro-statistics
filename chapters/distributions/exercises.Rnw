...
p_m_3.6_3 <- round(c(Verbal=runif(1, 148, 154), Quantitative=runif(1, 150, 156)))
p_sd_3.6_3 <- round(c(Verbal=runif(1, 6, 8), Quantitative=runif(1, 6.67, 8.67)))
...
\eoce{
  ...
  Graduate Record Examination (GRE) scored $\Sexpr{x_3.6_3[1]}$ on
  the Verbal Reasoning section and $\Sexpr{x_3.6_3[2]}$ on the
  Quantitpative Reasoning section. The mean score for Verbal Reasoning
  section for all test takers was $\Sexpr{p_m_3.6_3[1]}$ with a standard
  deviation of $\Sexpr{p_sd_3.6_3[1]}$, and the mean score for the
  Quantitative Reasoning was $\Sexpr{p_m_3.6_3[2]}$ with a standard deviation of
  $\Sexpr{p_sd_3.6_3[2]}$. Suppose that both distributions are nearly normal.
