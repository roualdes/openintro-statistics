...
\begin{figure}[hht]
\centering
\includegraphics[width=0.85\textwidth]{chapters/distributions/figures/twoSampleNormals/twoSampleNormals}
...
\begin{figure}[hht]
\centering
\includegraphics[width=0.6\textwidth]{chapters/distributions/figures/twoSampleNormalsStacked/twoSampleNormalsStacked}
...
\begin{figure}
\centering
\includegraphics[width=65mm]{chapters/distributions/figures/satActNormals/satActNormals}
...
\begin{figure}[htb]
   \centering
   \includegraphics[width=0.6\textwidth]{chapters/distributions/figures/satBelow1800/satBelow1800}
...
\begin{figure}
\centering
\includegraphics[width=0.9\textwidth]{chapters/distributions/figures/normalTails/normalTails}
...
\begin{center}
\includegraphics[width=0.45\textwidth]{chapters/distributions/figures/satAbove1630/satAbove1630}
\end{center}
...
\begin{center}
\includegraphics[width=0.5\textwidth]{chapters/distributions/figures/subtractingArea/subtractingArea}
\end{center}
...
\begin{center}
\includegraphics[width=0.4\textwidth]{chapters/distributions/figures/satBelow1400/satBelow1400}
\end{center}
...
\includegraphics[height=12mm]{chapters/distributions/figures/satBelow1400/satAbove1400}}
\end{exercise}
...
\begin{exercise}
Mike is 5'7'' and Jim is 6'4''. (a) What is Mike's height percentile? (b) What is Jim's height percentile? Also draw one picture for each~part.\footnote{First put the heights into inches: 67 and 76 inches. Figures are shown below. (a) $Z_{Mike} = \frac{67 - 70}{3.3} = -0.91\ \to\ 0.1814$. (b) $Z_{Jim} = \frac{76 - 70}{3.3} = 1.82\ \to\ 0.9656$. \\\includegraphics[height=12mm]{chapters/distributions/figures/mikeAndJimPercentiles/mikeAndJimPercentiles}}
\end{exercise}
...
\begin{center}
\includegraphics[width=0.35\textwidth]{chapters/distributions/figures/height40Perc/height40Perc}\vspace{-1mm}
\end{center}
...
\begin{center}
\includegraphics[width=0.28\textwidth]{chapters/distributions/figures/height82Perc/height82Perc}\textC{\vspace{-1mm}}
\end{center}
...
\begin{center}
\includegraphics[width=0.35\textwidth]{chapters/distributions/figures/between59And62/between59And62}\textC{\vspace{-2mm}}
\end{center}
...
\begin{center}
\includegraphics[width=0.6\textwidth]{chapters/distributions/figures/subtracting2Areas/subtracting2Areas}\textC{\vspace{-2mm}}
\end{center}
...
\begin{figure}[hht]
\centering
\includegraphics[height=1.9in]{chapters/distributions/figures/6895997/6895997}
...
\begin{figure}
\centering
\includegraphics[width=0.8\textwidth]{chapters/distributions/figures/fcidMHeights/fcidMHeights}
...
\begin{figure}
\centering
\includegraphics[width=\textwidth]{chapters/distributions/figures/normalExamples/normalExamples}
...
\begin{figure}
\centering
\includegraphics[width=\textwidth]{chapters/distributions/figures/nbaNormal/nbaNormal}
...
\begin{figure}
\centering
\includegraphics[width=\textwidth]{chapters/distributions/figures/pokerNormal/pokerNormal}
...
\begin{figure}
\centering
\includegraphics[width=0.9\textwidth]{chapters/distributions/figures/normalQuantileExer/normalQuantileExer}
...
\begin{figure}
\centering
\includegraphics[width=0.9\textwidth]{chapters/distributions/figures/normalQuantileExer/normalQuantileExerAdditional}
...
\begin{figure}
\centering
\includegraphics[width=0.8\textwidth]{chapters/distributions/figures/geometricDist35/geometricDist35}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.92\textwidth]{chapters/distributions/figures/fourBinomialModelsShowingApproxToNormal/fourBinomialModelsShowingApproxToNormal}
...
\begin{figure}[h]
\centering
\includegraphics[width=\textwidth]{chapters/distributions/figures/normApproxToBinomFail/normApproxToBinomFail}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.7\textwidth]{chapters/distributions/figures/amiIncidencesOver100Days/amiIncidencesOver100Days}
