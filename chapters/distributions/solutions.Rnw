...
\eocesol{
  ...
  (a)~$\Sexpr{z_3.6_1a_ans}\%$. \\
  (b)~$\Sexpr{z_3.6_1b_ans}\%$.\\
  (c)~$\Sexpr{z_3.6_1c_ans}\%$. \\
  (d)~$\Sexpr{z_3.6_1d_ans}\%$. \\


<<ex3_6_1_plots, echo=FALSE, fig.width=3, fig.height=3, fig.align="center", fig.show="hold">>=
gridExtra::grid.arrange(p_3.6_1a, p_3.6_1b, p_3.6_1c, p_3.6_1d, ncol=2)
@
...
\eocesol{
  ...
  (a)~Verbal: $N(\mu = \Sexpr{pm_3.6_3[1]}, \sigma = \Sexpr{psd_3.6_3[1]})$, Quant: $N(\mu = \Sexpr{pm_3.6_3[2]}, \sigma = \Sexpr{psd_3.6_3[2]})$.
  (b)~$Z_{VR}=\Sexpr{z_3.6_3[1]}$, ~$Z_{QR}=\Sexpr{z_3.6_3[2]}$. \\

<<echo=FALSE, fig.width=3, fig.height=2, fig.align="center">>=
annotate_stdNormal(z_3.6_3, dnorm(z_3.6_3))
@

  % \includegraphics[width=0.3\textwidth]{chapters/distributions/figures/eoce/GRE_intro/GRE_intro.pdf} \\
  (c)~She scored $\Sexpr{abs(z_3.6_3[1])}$ standard deviations \Sexpr{ifelse(z_3.6_3[1] > 0, "above", "below")} the mean on the Verbal
  Reasoning section and $\Sexpr{abs(z_3.6_3[2])}$ standard deviations \Sexpr{ifelse(z_3.6_3[2] > 0, "above", "below")} the mean on the
  Quantitative Reasoning section.
  (d)~She did better on the \Sexpr{which_better_3.6_3} Reasoning section since her Z-score on that
  section was higher.
  (e)~$Perc_{VR} \approx \Sexpr{perc_vr_3.6_3}\%$, $Perc_{QR} \approx \Sexpr{perc_qr_3.6_3}\%$.
  (f)~$100\% - \Sexpr{perc_vr_3.6_3}\% = \Sexpr{100 - perc_vr_3.6_3}\%$ did better than her on VR, and $100\% - \Sexpr{perc_qr_3.6_3}\% = \Sexpr{100 - perc_qr_3.6_3}\%$
...
\eocesol{
  ...
  (a)~$Z = 0.84$, which corresponds to approximately $\Sexpr{q80_3.6_5}$ on QR.
  (b)~$Z = -0.52$, which corresponds to approximately $\Sexpr{q30_3.6_5}$ on VR.
...
\eocesol{
  ...
  (a)~$Z=\Sexpr{z_3.6_7a} \to \Sexpr{p83_3.6_7}1$. \\
  (b)~$Z= \Sexpr{z_3.6_7b}8 \to \Sexpr{q10_3.6_7}\degree$F or colder.
...
\eocesol{
  ...
  (a)~$N(\Sexpr{pm_3.6_9}, \Sexpr{psd_3.6_9})$.
  (b)~$Z = \Sexpr{z_3.6_9} \to \Sexpr{p_3.6_9}$.
  ...
  = $\Sexpr{q25_3.6_9}$, Q3 = $\Sexpr{q75_3.6_9}$, IQR =
  $\Sexpr{iqr_3.6_9}$. $\Sexpr{q75_3.6_9} - \Sexpr{q25_3.6_9} = \Sexpr{iqr_3.6_9}$.
