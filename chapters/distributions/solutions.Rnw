...
<<ex_3.6_1_ans, fig.width=3, fig.height=3, fig.align="center", echo=FALSE>>=
p_3.6_1a_ans <- shade_stdNormal(x<z_3.6_1a)
p_3.6_1b_ans <- shade_stdNormal(x>z_3.6_1b)
p_3.6_1c_ans <- shade_stdNormal(x>z_3.6_1c[1] & x<z_3.6_1c[2])
p_3.6_1d_ans <- shade_stdNormal(x>abs(z_3.6_1d), x< -1*abs(z_3.6_1d))

gridExtra::grid.arrange(p_3.6_1a_ans, p_3.6_1b_ans,
                        p_3.6_1c_ans, p_3.6_1d_ans,
                        ncol=2)
@
