...
\begin{figure}[h]
\centering
\includegraphics[width=0.48\textwidth]{chapters/inference_props/figures/nuclearArmsReduction/nuclearArmsReductionPValue}
...
\end{align*}
\begin{center}
\includegraphics[width=0.6\textwidth]{chapters/inference_props/figures/mammograms/mammogramPValue}
\end{center}
...
\begin{figure}
\centering
\includegraphics[width=0.6\textwidth]{chapters/inference_props/figures/quadcopter/quadcopter_david_j}
...
\begin{figure}
\centering
\includegraphics[width=0.5\textwidth]{chapters/inference_props/figures/bladesTwoSampleHTPValueQC/bladesTwoSampleHTPValueQC}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.9\textwidth]{chapters/inference_props/figures/chiSquareDistributionWithInceasingDF/chiSquareDistributionWithInceasingDF}
...
\centering
\subfigure[]{
\includegraphics[width=0.475\textwidth]{chapters/inference_props/figures/arrayOfFigureAreasForChiSquareDistribution/chiSquareAreaAbove6Point25WithDF3/chiSquareAreaAbove6Point25WithDF3}
\label{chiSquareAreaAbove6Point25WithDF3}
}
\subfigure[]{
\includegraphics[width=0.475\textwidth]{chapters/inference_props/figures/arrayOfFigureAreasForChiSquareDistribution/chiSquareAreaAbove4Point3WithDF2/chiSquareAreaAbove4Point3WithDF2}
\label{chiSquareAreaAbove4Point3WithDF2}
}
\subfigure[]{
\includegraphics[width=0.475\textwidth]{chapters/inference_props/figures/arrayOfFigureAreasForChiSquareDistribution/chiSquareAreaAbove5Point1WithDF5/chiSquareAreaAbove5Point1WithDF5}
\label{chiSquareAreaAbove5Point1WithDF5}
}
\subfigure[]{
\includegraphics[width=0.475\textwidth]{chapters/inference_props/figures/arrayOfFigureAreasForChiSquareDistribution/chiSquareAreaAbove11Point7WithDF7/chiSquareAreaAbove11Point7WithDF7}
\label{chiSquareAreaAbove11Point7WithDF7}
}
\subfigure[]{
\includegraphics[width=0.475\textwidth]{chapters/inference_props/figures/arrayOfFigureAreasForChiSquareDistribution/chiSquareAreaAbove10WithDF4/chiSquareAreaAbove10WithDF4}
\label{chiSquareAreaAbove10WithDF4}
}
\subfigure[]{
\includegraphics[width=0.475\textwidth]{chapters/inference_props/figures/arrayOfFigureAreasForChiSquareDistribution/chiSquareAreaAbove9Point21WithDF3/chiSquareAreaAbove9Point21WithDF3}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.55\textwidth]{chapters/inference_props/figures/jurorHTPValueShown/jurorHTPValueShown}
...
\begin{figure}
\centering
\includegraphics[width=0.98\textwidth]{chapters/inference_props/figures/geomFitEvaluationForSP500For1990To2011/geomFitEvaluationForSP500For1990To2011}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.9\textwidth]{chapters/inference_props/figures/geomFitPValueForSP500For1990To2011/geomFitPValueForSP500For1990To2011}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.7\textwidth]{chapters/inference_props/figures/googleHTForDiffAlgPerformancePValue/googleHTForDiffAlgPerformancePValue}
...
\begin{figure}
\centering
\includegraphics[width=0.9\textwidth]{chapters/inference_props/figures/nullDistForPHatIfLiverTransplantConsultantIsNotHelpful/nullDistForPHatIfLiverTransplantConsultantIsNotHelpful}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.9\textwidth]{chapters/inference_props/figures/jurorChiSquareSimulated/jurorChiSquareSimulated}
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.67\textwidth]{chapters/inference_props/figures/pValueCPRStudyLargeSampleAnalysisInSmallSampleSection/pValueCPRStudyLargeSampleAnalysisInSmallSampleSection}
...
\begin{figure}
\centering
\includegraphics[width=\textwidth]{chapters/inference_props/figures/pValueCPRStudySmallSampleAnalysisInSmallSampleSection/pValueCPRStudySmallSampleAnalysisInSmallSampleSection}
