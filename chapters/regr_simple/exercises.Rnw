...
look like.
\begin{center}
\includegraphics[width=0.42\textwidth]{chapters/regr_simple/figures/eoce/visualize_residuals/visualize_residuals_linear.pdf}
\includegraphics[width=0.42\textwidth]{chapters/regr_simple/figures/eoce/visualize_residuals/visualize_residuals_fan_back.pdf}
\end{center}
}{}
...
\begin{center}
\includegraphics[width=0.42\textwidth]{chapters/regr_simple/figures/eoce/trends_in_residuals/trends_in_residuals_fan.pdf}
\includegraphics[width=0.42\textwidth]{chapters/regr_simple/figures/eoce/trends_in_residuals/trends_in_residuals_log.pdf}
\end{center}
}{}
...
reasonable.
\begin{center}
\includegraphics[width=0.32\textwidth]{chapters/regr_simple/figures/eoce/identify_relationships_1/identify_relationships_u.pdf}
\includegraphics[width=0.32\textwidth]{chapters/regr_simple/figures/eoce/identify_relationships_1/identify_relationships_lin_pos_strong.pdf}
\includegraphics[width=0.32\textwidth]{chapters/regr_simple/figures/eoce/identify_relationships_1/identify_relationships_lin_pos_weak.pdf}
\includegraphics[width=0.32\textwidth]{chapters/regr_simple/figures/eoce/identify_relationships_1/identify_relationships_n.pdf}
\includegraphics[width=0.32\textwidth]{chapters/regr_simple/figures/eoce/identify_relationships_1/identify_relationships_lin_neg_strong.pdf}
\includegraphics[width=0.32\textwidth]{chapters/regr_simple/figures/eoce/identify_relationships_1/identify_relationships_none.pdf}
\end{center}
}{}
...
reasonable.
\begin{center}
\includegraphics[width=0.32\textwidth]{chapters/regr_simple/figures/eoce/identify_relationships_2/identify_relationships_s.pdf}
\includegraphics[width=0.32\textwidth]{chapters/regr_simple/figures/eoce/identify_relationships_2/identify_relationships_hockey_stick.pdf}
\includegraphics[width=0.32\textwidth]{chapters/regr_simple/figures/eoce/identify_relationships_2/identify_relationships_pos_lin_strong.pdf}
\includegraphics[width=0.32\textwidth]{chapters/regr_simple/figures/eoce/identify_relationships_2/identify_relationships_pos_weak.pdf}
\includegraphics[width=0.32\textwidth]{chapters/regr_simple/figures/eoce/identify_relationships_2/identify_relationships_pos_weaker.pdf}
\includegraphics[width=0.32\textwidth]{chapters/regr_simple/figures/eoce/identify_relationships_2/identify_relationships_neg_lin_weak.pdf}
\end{center}
}{}
...
\end{parts}
\begin{center}
\includegraphics[width=0.49\textwidth]{chapters/regr_simple/figures/eoce/exams_grades_correlation/exam_grades_1.pdf}\ \
\includegraphics[width=0.49\textwidth]{chapters/regr_simple/figures/eoce/exams_grades_correlation/exam_grades_2.pdf}
\end{center}
}{}
...
\begin{center}
\includegraphics[width=0.38\textwidth]{chapters/regr_simple/figures/eoce/husbands_wives_correlation/husbands_wives_age.pdf} \hspace{5mm}
\includegraphics[width=0.38\textwidth]{chapters/regr_simple/figures/eoce/husbands_wives_correlation/husbands_wives_height.pdf}
\end{center}
\begin{parts}
...
\eoce{\qt{Match the correlation, Part I\label{matchapters/corr_1}} Match the calculated
...
\begin{center}
\includegraphics[width=0.45\textwidth]{chapters/regr_simple/figures/eoce/match_corr_1/match_corr_1_u.pdf}
\includegraphics[width=0.45\textwidth]{chapters/regr_simple/figures/eoce/match_corr_1/match_corr_2_strong_pos.pdf} \\
\includegraphics[width=0.45\textwidth]{chapters/regr_simple/figures/eoce/match_corr_1/match_corr_3_weak_pos.pdf}
\includegraphics[width=0.45\textwidth]{chapters/regr_simple/figures/eoce/match_corr_1/match_corr_4_weak_neg.pdf}
\end{center}
\end{minipage}
...
\noindent \begin{minipage}[c]{0.43\textwidth}
\eoce{\qt{Match the correlation, Part II\label{matchapters/corr_2}} Match the
...
\begin{minipage}[c]{0.57\textwidth}
\begin{center}
\includegraphics[width=0.45\textwidth]{chapters/regr_simple/figures/eoce/match_corr_2/match_corr_1_strong_neg_curved.pdf}
\includegraphics[width= 0.45\textwidth]{chapters/regr_simple/figures/eoce/match_corr_2/match_corr_2_weak_pos.pdf} \\
\includegraphics[width= 0.45\textwidth]{chapters/regr_simple/figures/eoce/match_corr_2/match_corr_3_n.pdf}
\includegraphics[width= 0.45\textwidth]{chapters/regr_simple/figures/eoce/match_corr_2/match_corr_4_weak_neg.pdf}
\end{center}
\end{minipage}
...
\begin{center}
\includegraphics[width=0.485\textwidth]{chapters/regr_simple/figures/eoce/speed_height_gender/speed_height.pdf}\hspace{0.02\textwidth}%
\includegraphics[width=0.485\textwidth]{chapters/regr_simple/figures/eoce/speed_height_gender/speed_height_gender.pdf}
\end{center}
\begin{parts}
...
\begin{center}
\includegraphics[width=0.485\textwidth]{chapters/regr_simple/figures/eoce/trees_volume_height_diameter/trees_volume_height.pdf}\hspace{0.02\textwidth}%
\includegraphics[width=0.485\textwidth]{chapters/regr_simple/figures/eoce/trees_volume_height_diameter/trees_volume_diameter.pdf}
\end{center}
\begin{parts}
...
\includegraphics[width=\textwidth]{chapters/regr_simple/figures/eoce/coast_starlight_corr_units/coast_starlight.pdf}
\end{minipage}
}{}
...
\end{minipage}
\begin{minipage}[c]{0.52\textwidth}
\includegraphics[width=\textwidth]{chapters/regr_simple/figures/eoce/crawling_babies_corr_units/crawling_babies.pdf}
\end{minipage}
}{}
...
\end{minipage}
\begin{minipage}[c]{0.52\textwidth}
\includegraphics[width=\textwidth]{chapters/regr_simple/figures/eoce/body_measurements_shoulder_height_corr_units/body_measurements_height_shoulder_girth.pdf}
\end{minipage}
}{}
...
\end{minipage}
\begin{minipage}[c]{0.52\textwidth}
\includegraphics[width=\textwidth]{chapters/regr_simple/figures/eoce/body_measurements_hip_weight_corr_units/body_measurements_weight_hip_girth.pdf}
\end{minipage}
}{}
...
\begin{center}
\includegraphics[width=0.32\textwidth]{chapters/regr_simple/figures/eoce/tourism_spending_reg_conds/tourism_spending_count.pdf}
\includegraphics[width=0.32\textwidth]{chapters/regr_simple/figures/eoce/tourism_spending_reg_conds/tourism_spending_count_residuals.pdf}
\includegraphics[width=0.32\textwidth]{chapters/regr_simple/figures/eoce/tourism_spending_reg_conds/tourism_spending_count_residuals_hist.pdf}
\end{center}
\begin{parts}
...
\begin{center}
\includegraphics[width=0.32\textwidth]{chapters/regr_simple/figures/eoce/starbucks_cals_carbos/starbucks_cals_carbos.pdf}
\includegraphics[width=0.32\textwidth]{chapters/regr_simple/figures/eoce/starbucks_cals_carbos/starbucks_cals_carbos_residuals.pdf}
\includegraphics[width=0.32\textwidth]{chapters/regr_simple/figures/eoce/starbucks_cals_carbos/starbucks_cals_carbos_residuals_hist.pdf}
\end{center}
\begin{parts}
...
\begin{minipage}[c]{0.4\textwidth}
\begin{center}
\includegraphics[width= \textwidth]{chapters/regr_simple/figures/eoce/starbucks_cals_protein/starbucks_cals_protein.pdf} \\
\end{center}
\end{minipage}
...
\begin{center}
\includegraphics[width= \textwidth]{chapters/regr_simple/figures/eoce/helmet_lunch/helmet_lunch.pdf} \\
\end{center}
\end{minipage}
}{}
...
\end{minipage}
\begin{minipage}[c]{0.4\textwidth}
\includegraphics[width=0.99\textwidth]{chapters/regr_simple/figures/eoce/murders_poverty_reg/murders_poverty.pdf}
\end{minipage}
}{}
...
\end{minipage}
\begin{minipage}[c]{0.4\textwidth}
\includegraphics[width=0.99\textwidth]{chapters/regr_simple/figures/eoce/cat_body_heart_reg/cat_body_heart.pdf}
\end{minipage}
}{}
...
your reasoning.
\begin{center}
\includegraphics[width=0.32\textwidth]{chapters/regr_simple/figures/eoce/outliers_1/outliers_1_influential.pdf}
\includegraphics[width=0.32\textwidth]{chapters/regr_simple/figures/eoce/outliers_1/outliers_2_leverage.pdf}
\includegraphics[width=0.32\textwidth]{chapters/regr_simple/figures/eoce/outliers_1/outliers_3_outlier.pdf}
\end{center}
}{}
...
your reasoning.
\begin{center}
\includegraphics[width=0.32\textwidth]{chapters/regr_simple/figures/eoce/outliers_2/outliers_1_influential.pdf}
\includegraphics[width=0.32\textwidth]{chapters/regr_simple/figures/eoce/outliers_2/outliers_2_influential.pdf}
\includegraphics[width=0.32\textwidth]{chapters/regr_simple/figures/eoce/outliers_2/outliers_3_outlier.pdf}
\end{center}
}{}
...
\end{minipage}
\begin{minipage}[c]{0.4\textwidth}
\includegraphics[width=0.95\textwidth]{chapters/regr_simple/figures/eoce/urban_homeowners_outlier/urban_homeowners_outlier.pdf} \vspace{-3mm}
\end{minipage}
}{}
...
\begin{minipage}[c]{0.4\textwidth}
\begin{center}
\includegraphics[width=\textwidth]{chapters/regr_simple/figures/eoce/body_measurements_weight_height_inf/body_measurements_weight_height.pdf}
\end{center}
\end{minipage}
...
\begin{minipage}[c]{0.4\textwidth}
\begin{center}
\includegraphics[width=0.76\textwidth]{chapters/regr_simple/figures/eoce/beer_blood_alcohol_inf/beer_blood_alcohol.pdf}
\end{center}
\end{minipage}
\begin{minipage}[c]{0.6\textwidth}
{\scriptsize
...
\begin{center}
\includegraphics[width=0.8\textwidth]{chapters/regr_simple/figures/eoce/husbands_wives_height_inf/husbands_wives_height.pdf}
\end{center}
\end{minipage}
\begin{minipage}[c]{0.6\textwidth}
{\scriptsize
...
\begin{minipage}[c]{0.4\textwidth}
\begin{center}
\includegraphics[width=\textwidth]{chapters/regr_simple/figures/eoce/husbands_wives_age_inf/husbands_wives_age.pdf}
\end{center}
\end{minipage}
\begin{minipage}[c]{0.6\textwidth}
{\scriptsize
...
\begin{minipage}[c]{0.4\textwidth}
\begin{center}
\includegraphics[width=\textwidth]{chapters/regr_simple/figures/eoce/urban_homeowners_cond/urban_homeowners_cond.pdf}
\end{center}
\end{minipage}
}{}
...
\noindent\begin{minipage}[c]{0.4\textwidth}
\includegraphics[width=\textwidth]{chapters/regr_simple/figures/eoce/rate_my_prof/rate_my_prof_eval_beauty.pdf} \\
\end{minipage}
\begin{minipage}[c]{0.6\textwidth}
\begin{tabular}{rrrrr}
    \hline
...
\begin{center}
\includegraphics[width=0.4\textwidth]{chapters/regr_simple/figures/eoce/rate_my_prof/rate_my_prof_residuals.pdf}
\includegraphics[width=0.4\textwidth]{chapters/regr_simple/figures/eoce/rate_my_prof/rate_my_prof_residuals_hist.pdf} \\
\includegraphics[width=0.4\textwidth]{chapters/regr_simple/figures/eoce/rate_my_prof/rate_my_prof_residuals_qq.pdf}
\includegraphics[width=0.4\textwidth]{chapters/regr_simple/figures/eoce/rate_my_prof/rate_my_prof_residuals_order.pdf}
\end{center}
\end{parts}
}{}
