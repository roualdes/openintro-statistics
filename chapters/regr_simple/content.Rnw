...
\begin{figure}
   \centering
   \includegraphics[width=0.65\textwidth]{chapters/regr_simple/figures/perfLinearModel/perfLinearModel}
...
\begin{figure}
   \centering
   \includegraphics[width=\textwidth]{chapters/regr_simple/figures/imperfLinearModel/imperfLinearModel}
...
\begin{figure}
   \centering
   \includegraphics[width=0.9\textwidth]{chapters/regr_simple/figures/notGoodAtAllForALinearModel/notGoodAtAllForALinearModel}
...
\begin{figure}
   \centering
   \includegraphics[width=0.85\textwidth]{chapters/regr_simple/figures/scattHeadLTotalL/scattHeadLTotalL}
...
\begin{figure}
   \centering
   \includegraphics[width=0.9\textwidth]{chapters/regr_simple/figures/brushtail_possum/brushtail_possum}
...
\begin{figure}
   \centering
   \includegraphics[width=\textwidth]{chapters/regr_simple/figures/scattHeadLTotalLTube/scattHeadLTotalLTube}
...
\begin{figure}
   \centering
   \includegraphics[width=0.71\textwidth]{chapters/regr_simple/figures/scattHeadLTotalLLine/scattHeadLTotalLLine}
...
\begin{figure}
   \centering
   \includegraphics[width=0.73\textwidth]{chapters/regr_simple/figures/scattHeadLTotalLResidualPlot/scattHeadLTotalLResidualPlot}
...
\begin{figure}
   \centering
   \includegraphics[width=0.95\textwidth]{chapters/regr_simple/figures/sampleLinesAndResPlots/sampleLinesAndResPlots}
...
\begin{figure}
   \centering
   \includegraphics[width=0.95\textwidth]{chapters/regr_simple/figures/posNegCorPlots/posNegCorPlots}
...
\begin{figure}
   \centering
   \includegraphics[width=0.96\textwidth]{chapters/regr_simple/figures/posNegCorPlots/corForNonLinearPlots}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.75\textwidth]{chapters/regr_simple/figures/elmhurstPlots/elmhurstScatterW2Lines}
...
\begin{figure}
\centering
\includegraphics[width=\textwidth]{chapters/regr_simple/figures/whatCanGoWrongWithLinearModel/whatCanGoWrongWithLinearModel}
...
\begin{figure}
\centering
\includegraphics[width=0.75\textwidth]{chapters/regr_simple/figures/elmhurstPlots/elmhurstScatterWLSROnly}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.65\textwidth]{chapters/regr_simple/figures/marioKartNewUsed/marioKartNewUsed}
...
\begin{figure}
\centering
\includegraphics[width=\textwidth]{chapters/regr_simple/figures/outlierPlots/outlierPlots}
...
\begin{figure}
\centering
\includegraphics[width=\textwidth]{chapters/regr_simple/figures/unemploymentAndChangeInHouse/unemploymentAndChangeInHouse}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.82\textwidth]{chapters/regr_simple/figures/oneSidedTailForMidtermUnemploymentHT/oneSidedTailForMidtermUnemploymentHT}
