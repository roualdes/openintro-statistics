...
\begin{figure}
\centering
\includegraphics[height=45mm]{chapters/inference_means/figures/tDistCompareToNormalDist/tDistCompareToNormalDist}
...
\begin{figure}
\centering
\includegraphics[width=0.8\textwidth]{chapters/inference_means/figures/tDistConvergeToNormalDist/tDistConvergeToNormalDist}
...
\begin{figure}
\centering
\includegraphics[width=0.5\textwidth]{chapters/inference_means/figures/tDistDF18LeftTail2Point10/tDistDF18LeftTail2Point10}
...
\begin{figure}
\centering
\includegraphics[width=0.85\textwidth]{chapters/inference_means/figures/tDistDF20RightTail1Point65/tDistDF20RightTail1Point65}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.8\textwidth]{chapters/inference_means/figures/rissosDolphin/rissosDolphin.jpg}  \\
\addvspace{2mm}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.65\textwidth]{chapters/inference_means/figures/run10SampTimeHistogram/run10SampTimeHistogram}
...
\begin{figure}
\centering
\includegraphics[width=0.93\textwidth]{chapters/inference_means/figures/textbooksS10/diffInTextbookPricesS10}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.65\textwidth]{chapters/inference_means/figures/textbooksS10/textbooksS10HTTails}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.58\textwidth]{chapters/inference_means/figures/stemCellTherapyForHearts/stemCellTherapyForHearts}
...
\begin{figure}[hhh]
\centering
\includegraphics[width=0.63\textwidth]{chapters/inference_means/figures/babySmokePlotOfTwoGroupsToExamineSkew/babySmokePlotOfTwoGroupsToExamineSkew}
...
\begin{center}
\includegraphics[width=0.6\textwidth]{chapters/inference_means/figures/distOfDiffOfSampleMeansForBWOfBabySmokeData/distOfDiffOfSampleMeansForBWOfBabySmokeData}
\end{center}
\end{example}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.63\textwidth]{chapters/inference_means/figures/pValueOfTwoTailAreaOfExamVersionsWhereDFIs26/pValueOfTwoTailAreaOfExamVersionsWhereDFIs26}
...
\begin{center}
\includegraphics[width=0.93\textwidth]{chapters/inference_means/figures/power_null_0_1-7/power_null_A_0_1-7}
\end{center}
\end{example}
...
\begin{center}
\includegraphics[width=0.93\textwidth]{chapters/inference_means/figures/power_null_0_1-7/power_null_B_0_1-7_with_rejection_region}
\end{center}
\end{example}
...
\begin{center}
\includegraphics[width=0.87\textwidth]{chapters/inference_means/figures/power_null_0_1-7/power_null_C_0_1-7_with_alt_at_3}
\end{center}
...
\begin{center}
\includegraphics[width=0.93\textwidth]{chapters/inference_means/figures/power_null_0_1-7/power_null_D_0_1-7_with_alt_at_3_and_shaded}
\end{center}
...
\includegraphics[width=0.9\textwidth]{chapters/inference_means/figures/power_null_0_0-76/power_null_0_0-76_with_alt_at_3_and_shaded} \\
...
\begin{center}
\includegraphics[width=0.93\textwidth]{chapters/inference_means/figures/power_best_sample_size/power_best_sample_size}
\end{center}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.9\textwidth]{chapters/inference_means/figures/power_curve/power_curve_neg-3}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.68\textwidth]{chapters/inference_means/figures/toyANOVA/toyANOVA}
...
\begin{figure}
\centering
\includegraphics[width=0.7\textwidth]{chapters/inference_means/figures/mlbANOVA/mlbANOVABoxPlot}
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.65\textwidth]{chapters/inference_means/figures/fDist3And323/fDist3And323}
...
The test statistic for the baseball example is $F=1.994$. Shade the area corresponding to the p-value in Figure~\ref{fDist3And323}. \footnote{\ \vspace{-4mm}\\\includegraphics[height=20mm]{chapters/inference_means/figures/fDist3And323/fDist3And323Shaded}}
\end{exercise}
...
\begin{figure}[hhh]
\centering
\includegraphics[width=\textwidth]{chapters/inference_means/figures/mlbANOVA/mlbANOVADiagNormalityGroups}
...
\begin{figure}
\centering
\includegraphics[width=0.72\textwidth]{chapters/inference_means/figures/classData/classDataSBSBoxPlot}
