...
\begin{figure}
\centering
\includegraphics[width=0.725\textwidth]{chapters/regr_mult_and_log/figures/marioKartSingle/marioKartSingle}
...
\label{introductionToModelSelection}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.71\textwidth]{chapters/regr_mult_and_log/figures/marioKartDiagnostics/mkDiagnosticNormalQuantilePlot}
...
\begin{figure}
\centering
\includegraphics[width=0.7\textwidth]{chapters/regr_mult_and_log/figures/marioKartDiagnostics/mkDiagnosticEvsAbsF}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.72\textwidth]{chapters/regr_mult_and_log/figures/marioKartDiagnostics/mkDiagnosticInOrder}
...
\begin{figure}
\centering
\includegraphics[width=\textwidth]{chapters/regr_mult_and_log/figures/marioKartDiagnostics/mkDiagnosticEvsVariables}
...
\begin{figure}
\centering
\includegraphics[width=\textwidth]{chapters/regr_mult_and_log/figures/logitTransformationFigureHoriz/logitTransformationFigureHoriz}
...
\begin{figure}[h]
\centering
\includegraphics[width=\textwidth]{chapters/regr_mult_and_log/figures/logisticModel/logisticModelPredict}
...
\begin{figure}
\centering
\includegraphics[width=\textwidth]{chapters/regr_mult_and_log/figures/logisticModel/logisticModelSpline}
