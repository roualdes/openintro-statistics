...
\begin{figure}
\centering
\includegraphics[width=0.8\textwidth]{chapters/inference_foundations/figures/yrbssSampHistograms/yrbssSampHistograms}
...
\begin{figure}[h]
   \centering
   \includegraphics[width=0.72\textwidth]{chapters/inference_foundations/figures/yrbssActiveRunningMean/yrbssActiveRunningMean}
...
\begin{figure}[h]
   \centering
   \includegraphics[width=0.9\textwidth]{chapters/inference_foundations/figures/yrbssActive1000SampDist/yrbssActive1000SampDist}
...
\begin{figure}[hht]
   \centering
   \includegraphics[width=0.78\textwidth]{chapters/inference_foundations/figures/95PercentConfidenceInterval/95PercentConfidenceInterval}
...
\begin{figure}[hht]
   \centering
   \includegraphics[width=\textwidth]{chapters/inference_foundations/figures/yrbssActiveBigSampDist/yrbssActiveBigSampDist}
...
\begin{figure}[h]
\centering
\includegraphics[width=\textwidth]{chapters/inference_foundations/figures/choosingZForCI/choosingZForCI}
...
\begin{figure}
\centering
\includegraphics[width=0.9\textwidth]{chapters/inference_foundations/figures/communityCollegeClaimedHousingExpenseDistribution/communityCollegeClaimedHousingExpenseDistribution}
...
\begin{figure}[hht]
\centering
\includegraphics[width=0.75\textwidth]{chapters/inference_foundations/figures/whyWeWantPValue/whyWeWantPValue}
...
\begin{figure}
\centering
\includegraphics[width=0.7\textwidth]{chapters/inference_foundations/figures/histOfSleepForCollegeThatWasCheckingForMoreThan7Hours/histOfSleepForCollegeThatWasCheckingForMoreThan7Hours}
...
\begin{figure}[hht]
   \centering
   \includegraphics[width=0.83\textwidth]{chapters/inference_foundations/figures/pValueOneSidedSleepStudy/pValueOneSidedSleepStudy}
...
\begin{figure}[ht]
   \centering
   \includegraphics[width=0.9\textwidth]{chapters/inference_foundations/figures/pValueOneSidedSleepStudyExplained/pValueOneSidedSleepStudyExplained}
...
\begin{figure}
   \centering
   \includegraphics[width=0.77\textwidth]{chapters/inference_foundations/figures/ebayMarioKartAuctionPriceHistogramFor3ConditionsExercise/ebayMarioKartAuctionPriceHistogramFor3ConditionsExercise}
...
\end{eqnarray*}
\begin{center}
\includegraphics[height=35mm]{chapters/inference_foundations/figures/pVForEbayAmazonComparison/pVForEbayAmazonComparison}
\end{center}
...
\begin{figure}
   \centering
   \includegraphics[width=0.9\textwidth]{chapters/inference_foundations/figures/2ndSchSleepHTExample/2ndSchSleepHTExample}
...
\begin{figure}
   \centering
   \includegraphics[width=0.7\textwidth]{chapters/inference_foundations/figures/type1ErrorDoublingExampleFigure/type1ErrorDoublingExampleFigure}
...
\begin{figure}
   \centering
   \includegraphics[width=\textwidth]{chapters/inference_foundations/figures/cltSimulations/cltSimulations}
...
\begin{figure}[ht]
   \centering
   \includegraphics[height=58mm]{chapters/inference_foundations/figures/pokerProfitsCanApplyNormalToSampMean/pokerProfitsCanApplyNormalToSampMean}
...
\begin{figure}[bt]
   \centering
   \includegraphics[width=0.88\textwidth]{chapters/inference_foundations/figures/sulphStudyFindPValueUsingNormalApprox/sulphStudyFindPValueUsingNormalApprox}
