...
\begin{minipage}[c]{0.7\textwidth}
<<plot4_6_4, echo=FALSE, fig.width=4, fig.height=2.5>>=
plot_4.6.4
@
\end{minipage}
\begin{minipage}[c]{0.2\textwidth}
...
<<giftedChildrenHist, opts.label="plot">>=
ggplot2::ggplot(openintro::gifted, ggplot2::aes(x=count)) +
    ggplot2::geom_histogram(bins=10) +
...
<<giftedChildrenMomIQHist, opts.label="plot">>=
ggplot2::ggplot(data=openintro::gifted, ggplot2::aes(x=motheriq)) +
    ggplot2::geom_histogram(bins=10) +
