...
\begin{center}
\includegraphics[width=0.7\textwidth]{ch_inference_props/figures/eoce/barking_deer_chisq_GOF/barking_deer.jpg} \\
...
\begin{center}
\includegraphics[width=0.8\textwidth]{ch_inference_props/figures/eoce/egypt_revolution_one_sample_randomization/egypt_revolution_one_sample_randomization.pdf}
\end{center}
...
\begin{center}
\includegraphics[width=0.85\textwidth]{ch_inference_props/figures/eoce/assisted_reproduction_one_sample_randomization/assisted_reproduction_one_sample_randomization.pdf}
\end{center}
\end{parts}
}{}
...
\begin{center}
\includegraphics[width=0.9\textwidth]{ch_inference_props/figures/eoce/social_experiment_two_sample_randomization/social_experiment_two_sample_randomization.pdf}
\end{center}
\begin{parts}
...
\begin{center}
\includegraphics[width=0.9\textwidth]{ch_inference_props/figures/eoce/yawning_two_sample_randomization/yawning_two_sample_randomization.pdf}
\end{center}
